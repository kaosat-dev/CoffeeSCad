...
(function() {
  ...
  define(function(require) {
    var DataStore, DataStoreManager, FsStore, GistStore, LocalStore;
    DataStoreManager = (function() {

      function DataStoreManager(debug) {
        var name, store, _ref;
        this.debug = debug != null ? debug : false;
        this.LocalStore = new LocalStore(this.debug);
        this.fsStore = new FsStore(this.debug);
        this.gistStore = new GistStore(this.debug);
        this.stores = {
