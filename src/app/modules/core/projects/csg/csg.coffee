  ...
  class CAGBase extends TransformBase
    ...
    @hullSub2:(divLine, points)->
      ...
      if furthestPoint? #did we find a max point ?
        hullDivLines = hullDivLines.concat(CAGBase.hullSub2([minPoint, furthestPoint], newPoints))#left
        hullDivLines = hullDivLines.concat(CAGBase.hullSub2([furthestPoint, maxPoint], newPoints))#right
        hullDivLines
    ...
    @hullSub2Init:(points)->
      ...
      leftResult = CAGBase.hullSub2([minPoint,maxPoint],points)
      for pt in leftResult
        resultPoints.push(pt[0])
        resultPoints.push(pt[1])
      
      rightResult = CAGBase.hullSub2([maxPoint,minPoint],points)
    ...
    @hullSub:(points)->
      ...
      if leftSet.length >= 0
        ...
        #console.log "farthest point in lefttSet"
        #console.log maxDistPoint
      ...
      if rightSet.length >= 0
        ...
        console.log "farthest point in rightSet"
        console.log maxDistPoint
        ###
        if maxDistPoint != null
        ...
        ###
        subResult = CAGBase.hullSub(rightSet)
        resultPoints = resultPoints.concat subResult
    ...
    @hull : (cag...) ->
      ...
      hullPoints = CAGBase.hullSub2Init(points)#CAGBase.hullSub(points)
