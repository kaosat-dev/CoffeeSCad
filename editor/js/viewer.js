...
(function() {
  ...
  OpenCoffeeScad.Viewer = (function() {

    function Viewer(containerelement, width, height, initialdepth) {
      var gl, msg,
        _this = this;
    ...
    Viewer.prototype.setCsg = function(csg) {
    ...
    Viewer.prototype.supported = function() {
      return !!this.gl;
    };
    ...
    Viewer.prototype.onDraw = function(e) {
      var gl;
      gl = this.gl;
      gl.makeCurrent();
    ...
    Viewer.prototype.csgToMesh = function(csg) {
